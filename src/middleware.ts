 ...
 * Supabase-Clients im Edge-Bundle. Jetzt wird die Tabelle einmal komplett geladen und
...
export const config = {
  ...
  // Endung sind ausgenommen, damit die Middleware im Normalbetrieb gar nicht erst läuft.
  matcher: [
